...
:: Compile command
%CSC% /target:library /out:mb_QuickTag.dll /reference:System.Windows.Forms.dll /reference:System.Drawing.dll /reference:System.Core.dll /reference:System.Data.dll Plugin.cs MusicBeeInterface.cs TagBrowserForm.cs SettingsForm.cs
...
echo ==========================================
echo [成功] 编译完成！
echo 插件文件已生成: %CD%\mb_QuickTag.dll
echo ==========================================
echo.
echo 请将 mb_QuickTag.dll 复制到 MusicBee 的 Plugins 文件夹中。
pause
